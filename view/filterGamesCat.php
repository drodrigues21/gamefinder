    ...
    <div id="filterFormContainer">
            ...
            <div class="placesContainer">
                ...
                <fieldset class="placesFieldset checkBoxStyle">
                    <legend class="placesLegend">
                        <input type="checkbox" name="location[]" value="indoor" id="indoor"<?= isset($checks["indoor"]) ?  'checked' : ''; ?> />
                        <label for="indoor"><span></span>Indoor</label>
                    </legend>
                    <div class="placesCheckboxes">
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="bar" id="bar" <?= isset($checks["bar"]) ?  'checked' : ''; ?> />
                            <label for="bar"><span></span> Bar</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="house" id="house" <?= isset($checks["house"]) ?  'checked' : ''; ?> />
                            <label for="house"><span></span>House</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="school" id="school" <?= isset($checks["school"]) ?  'checked' : ''; ?> />
                            <label for="school"><span></span>School</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="office" id="office" <?= isset($checks["office"]) ?  'checked' : ''; ?> />
                ...
                <fieldset class="placesFieldset checkBoxStyle">
                    <legend class="placesLegend">
                        <input type="checkbox" name="location[]" value="outdoor" id="outdoor" <?= isset($checks["outdoor"]) ?  'checked' : ''; ?> />
                        <label for="outdoor"><span></span>Outdoor</label>
                    </legend>
                    <div class="placesCheckboxes">
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="beach" id="beach" <?= isset($checks["beach"]) ? 'checked': ''; ?> />
                            <label for="beach"><span></span>Beach</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="car" id="car" <?= isset($checks["car"]) ?  'checked' : ''; ?> />
                            <label for="car"><span></span>Car</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="plane" id="plane"<?= isset($checks["plane"]) ?  'checked' : ''; ?> />
                            <label for="plane"><span></span>Plane</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="boat" id="boat" <?= isset($checks["boat"]) ?  'checked' : ''; ?> />
                            <label for="boat"><span></span>Boat</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="location[]" value="park" id="park"<?= isset($checks["park"]) ?  'checked' : ''; ?> />
        ...
        <div class="rightSideForm">
            ...
            <div class="settingContainer">
                ...
                <fieldset class="settingFieldset">
                    ...
                    <div class="settingCheckboxes">
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="partyWork" id="partyWork" <?= isset($checks["partyWork"]) ?  'checked' : ''; ?> />
                            <label for="partyWork"><span></span>Work Party</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="partyFriends" id="partyFriends" <?= isset($checks["partyFriends"]) ?  'checked' : ''; ?> />
                            <label for="partyFriends"><span></span>Friends Party</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="family" id="family"<?= isset($checks["family"]) ?  'checked' : ''; ?> />
                            <label for="family"><span></span>Family</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="date" id="date"<?= isset($checks["date"]) ?  'checked' : ''; ?> />
                            <label for="date"><span></span>Date</label>
                        </div>
                    </div>
                    <div class="settingCheckboxes">
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="camping" id="camping"<?= isset($checks["camping"]) ?  'checked' : ''; ?> />
                            <label for="camping"><span></span>Camping</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="icebreaker" id="icebreaker" <?= isset($checks["icebreaker"]) ?  'checked' : ''; ?> />
                            <label for="icebreaker"><span></span>Icebreaker</label>
                        </div>
                        <div class="checkBoxStyle">
                            <input type="checkbox" name="social[]" value="classmates" id="classmates"  <?= isset($checks["classmates"]) ?  'checked' : ''; ?> />
            ...
            <div class="prepAmount">
                ...
                <div class="radioGroup">
                    <input type="radio" id="low" name="prepSelector" value="min" <?= (isset($checks['prep']) and $checks['prep'] == "min") ? "checked" : "";?>/>                                                             
                    <label for="low">Low</label>
                    <input type="radio" id="medium" name="prepSelector" value="med" <?= (isset($checks['prep']) and $checks['prep'] == "med") ? "checked" : "";?>/> 
            ...
            <div class="timeRange">
                ...
                <div id="timeSlider" class="range-slider ">
                    <span id="timeBullet" class="timeSliderLabel"><?= (isset($checks['time']) and $time != 'anyT') ? $time : '5' ;?></span>
                    <input id="timeRange" type="range" min="5" max="60" value=<?= (isset($checks['time']) and $checks['time'] != "anyT")? $checks['time'] : "5";?> class="slider" name="timeRange">
                </div>
